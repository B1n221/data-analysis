...
## ------------------------------------------------------------------------
# 資料框loc 方法取值(注意此處冒號運算子為前包後也包!)
print(fb.loc[:10, ['地區','累積打卡數']])

## ------------------------------------------------------------------------
# 資料框iloc() 方法取值(注意此處冒號運算子卻又是前包後不包!)
print(fb.iloc[:10, [6, 2]])
...
## ------------------------------------------------------------------------
# 運用pandas 序列物件Series 之apply() 方法的隱式迴圈
import pandas as pd
